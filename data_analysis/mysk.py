# the script is copy-pasted for easier task completion
# original: https://github.com/NikolaiZolotykh/MachineLearningCourse/blob/master/mysk.py
# all credits to: https://github.com/NikolaiZolotykh
